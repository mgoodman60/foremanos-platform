...
export const metadata: Metadata = {
  ...
  description: 'Get a clear view of what\'s working and what\'s slipping. Simple reports that actually help.',
};
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto">
              Get a clear view of what's working and what's slipping.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
              ...
              <h3 className="text-xl font-semibold mb-3">See What's Behind</h3>
              <p className="text-gray-300">Identify delays before they cascade into bigger problems.</p>
            </div>
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
              <CheckCircle className="w-10 h-10 text-green-500 mb-4" />
              <h3 className="text-xl font-semibold mb-3">Track Crew Performance</h3>
              <p className="text-gray-300">Know who's hitting targets and who needs support.</p>
            </div>
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
              <CheckCircle className="w-10 h-10 text-green-500 mb-4" />
              <h3 className="text-xl font-semibold mb-3">Make Better Decisions</h3>
              <p className="text-gray-300">Use real data instead of gut feel.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Data Flows In Automatically</h3>
                <p className="text-gray-300">No manual entry—reports pull from your actual activity.</p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-xl font-bold">2</div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Simple Dashboards</h3>
                <p className="text-gray-300">See trends, spot issues, no spreadsheet wizardry required.</p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-xl font-bold">3</div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Export When Needed</h3>
                <p className="text-gray-300">Download reports for meetings, audits, or your own analysis.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Get a personalized walkthrough of reporting & analytics.
          </p>
