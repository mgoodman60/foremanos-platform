...
export function BudgetPageContent({ projectSlug }: { projectSlug: string }) {
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="job-cost" className="space-y-6">
            ...
            <CostCodeDrilldown projectSlug={projectSlug} />
          </TabsContent>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <BudgetVarianceWidget projectSlug={projectSlug} refreshInterval={30000} />
              <CostForecastWidget projectSlug={projectSlug} refreshInterval={60000} />
            </div>
            ...
            <ForecastActualChart projectSlug={projectSlug} />
          ...
          <TabsContent value="review" className="space-y-6">
            <LaborMaterialReview projectSlug={projectSlug} />
          </TabsContent>

          {/* Change Orders Tab */}
          <TabsContent value="change-orders">
            <ChangeOrderManager projectSlug={projectSlug} />
          </TabsContent>
