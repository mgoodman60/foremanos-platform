...
describe('getLegendStatistics', () => {
  const mockLegends = [
    {
      ...mockSheetLegend,
      legendEntries: [
        { id: '1', symbolCode: 'A', symbolDescription: 'Test', category: 'electrical', confidence: 0.9 },
        { id: '2', symbolCode: 'B', symbolDescription: 'Test', category: 'electrical', confidence: 0.9 },
      ],
      confidence: 0.9,
      discipline: 'E',
    },
    {
      ...
      sheetNumber: 'A1.2',
      legendEntries: [
        { id: '3', symbolCode: 'C', symbolDescription: 'Test', category: 'plumbing', confidence: 0.8 },
      ],
      confidence: 0.8,
      discipline: 'P',
    },
  ...
  it('should handle legends without discipline', async () => {
    ...
    const legendsWithoutDiscipline = [
      {
        ...mockSheetLegend,
        legendEntries: [{ id: '1', symbolCode: 'A', symbolDescription: 'Test', category: 'general', confidence: 0.9 }],
        confidence: 0.9,
