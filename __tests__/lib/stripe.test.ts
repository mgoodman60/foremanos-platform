...
describe('stripe module', () => {
  ...
  describe('SUBSCRIPTION_LIMITS', () => {
    ...
    it('should define starter tier limits', () => {
      ...
      expect(SUBSCRIPTION_LIMITS.starter.models).toContain('claude-3-5-sonnet-20241022');
    });
    ...
    it('should include gpt-4o in pro and higher tiers', () => {
      expect(SUBSCRIPTION_LIMITS.pro.models).toContain('gpt-4o');
      expect(SUBSCRIPTION_LIMITS.team.models).toContain('gpt-4o');
      expect(SUBSCRIPTION_LIMITS.business.models).toContain('gpt-4o');
      expect(SUBSCRIPTION_LIMITS.enterprise.models).toContain('gpt-4o');
    });

    it('should not include gpt-4o in free tier', () => {
      expect(SUBSCRIPTION_LIMITS.free.models).not.toContain('gpt-4o');
    });
  });
});
