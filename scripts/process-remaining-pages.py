#!/usr/bin/env python3
"""
Simple, robust processor for remaining regulatory pages
Processes in small batches with full error visibility
"""
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python process-remaining-pages.py [ibc|nfpa|both]")
        sys.exit(1)
